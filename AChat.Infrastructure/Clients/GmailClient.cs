...
public class GmailClient : IGmailClient
{
    ...
    public GmailClient(IOptions<GoogleSettings> googleSettings)
    {
    ...
    public async Task<List<GmailDto>> GetMessageAsync(UserCredential credential, ulong historyId)
    {
        var service = new GmailService(new BaseClientService.Initializer
        {
            HttpClientInitializer = credential
    ...
    public async Task SendGmailAsync(UserCredential credential, string from, string to, string subject, string body, string? threadId = default)
    {
        var service = new GmailService(new BaseClientService.Initializer
        {
            HttpClientInitializer = credential
        ...
        if (threadId != default)
        {
            ...
            mimeMessage.InReplyTo = replyId;
            mimeMessage.References.Add(replyId);
        }
